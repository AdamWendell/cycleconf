...
export declare type StreamSubscribe = (stream: any, observer: Observer) => DisposeFunction | void;
...
declare function Cycle<Sources, Sinks>(main: (sources: Sources) => Sinks, drivers: DriversDefinition, options: CycleOptions): CycleExecution<Sources, Sinks>;
